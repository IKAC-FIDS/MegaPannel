                ...
                <div className={'bg-white w-1/3 h-96 p-8 rounded-lg'} >
                    ...
                    <div className={'flex flex-col justify-center mb-8'}>
                        <Input label="نام کاربری"
                               labelPlacement="outside" className={"mb-8"} onChange={(e:any) => setCredentials({...credentials,userName:e.target.value})}/>
                        <Input label="رمز عبور"
                               labelPlacement="outside" onChange={(e:any) => setCredentials({...credentials,password:e.target.value})}/>
